        ...
        children: [
                    ...
                    children: [ 
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          ImageIcon(const AssetImage("res/images/sqrillnav.png"), size: TextResponsive.getResponsiveFontSize(context, 34), color: const Color(0xFFFFFFFF)),
                        ],
                      )
                    ],
                  ),
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding: EdgeInsets.only(right: SizeResponsive.get(context, 12), bottom: 14),
                            child: const ImageIcon(AssetImage("res/icons/blink.png"), size: 10, color: Color(0xFFFFFFFF),)))
                      ],
                    ),
                  ),
                ),
          ...
          Positioned(
            ...
            child: GestureDetector(
              ...
              child: Image.asset('res/images/clinic_map.png', width: 100,))),
        ],
      ),
    );
  }
