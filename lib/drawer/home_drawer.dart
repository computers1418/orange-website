...
class _HomeDrawerState extends State<HomeDrawer> with TickerProviderStateMixin {
  ...
  ValueNotifier<bool> isPreviousAppointments = ValueNotifier(false);
  ...
  void initState() {
    ...
    animation = Tween<double>(begin: 1000, end: 0).animate(CurvedAnimation(
        parent: controller2, reverseCurve: Curves.ease, curve: Curves.easeOut));
    super.initState();
  }
                  ...
                  child: Padding(
                    ...
                    child: GestureDetector(
                      ...
                      child: RotationTransition(
                        turns: Tween<double>(begin: 0.25, end: -0.25)
                            .animate(controller),
                        child: CircleAvatar(
            ...
            child: Row(
              children: [
                CircleAvatar(
                  ...
                  backgroundImage:
                      const AssetImage("res/images/placeholder.png"),
                ),
                16.hgap(),
                Expanded(
                  child: Column(
            ...
            child: Stack(
              children: [
                Positioned(
                  ...
                  right: 0,
                  child: Image.asset(
                    "res/images/bottom_wave.png",
                    height: SizeResponsive.getHeightverse(context, 85),
                    fit: BoxFit.fill,
                  ),
                ),
                Padding(
                  ...
                  child: Row(
                    children: [
                      Image.asset(
                        "res/images/mobile_app.png",
                        width: SizeResponsive.getHeightverse(context, 80),
                      ),
                      const SizedBox(
                        width: 8,
                      ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: 200,
                              child: Text(
                                "Download now to experience all features, updates and immersive experiences.",
                                maxLines: 4,
                                style: TextStyle(
                                  fontFamily: "Kumbhsans",
                                  color: const Color(0xFF2B275A),
