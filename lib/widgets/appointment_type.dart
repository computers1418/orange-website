              ...
              (e) => GestureDetector(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    color: val==e['id'] ? const Color(0xFFFF8412): Colors.white,
                    borderRadius: const BorderRadius.all(Radius.circular(30)),
                    border: Border.all(color: val==e['id'] ? Colors.white : const Color(0xFFFF8412), width: 3)
                  ),
                  alignment: Alignment.center,
                  padding: EdgeInsets.symmetric(vertical: SizeResponsive.get(context, 8), horizontal: 10),
                  child: Text('${e['label']}', style: TextStyle(
                    color: val==e['id'] ? Colors.white : const Color(0xFFFF8412),
