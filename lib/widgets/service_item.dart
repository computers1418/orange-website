...
class ServiceItem extends StatelessWidget {
  ...
  const ServiceItem({super.key, required this.onClick, required this.icon, required this.service, this.amount, this.selected = false});
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: selected ? const Color(0xFFFF8412) : const Color(0xFFF2F7FB)
        ),
        child: Row(
          children: [
            ...
            CircleAvatar(
              ...
              child: ImageIcon(AssetImage(icon), size: SizeResponsive.get(context, 20), color: selected ? const Color(0xFFFFFFFF) : const Color(0xFF2B275A),),
            ),
