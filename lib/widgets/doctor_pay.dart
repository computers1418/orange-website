...
class DoctorPay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: EdgeInsets.fromLTRB(16, SizeResponsive.get(context, 12), 16, SizeResponsive.get(context, 4)),
      decoration:  BoxDecoration(
        color: const Color(0xFF2B275A),
        borderRadius: BorderRadius.vertical(top: Radius.circular(SizeResponsive.get(context, 25)))
      ),
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [ 
                 Text("Dr. Veronica Smith", maxLines: 1, style: TextStyle(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text("Call Doctor Directly", style: TextStyle(
                        fontFamily: "Kumbhsans",
                     ...
                     SizedBox(width: SizeResponsive.get(context, 4),),
                    ImageIcon(const AssetImage("res/icons/sqrillnav.png"), size: SizeResponsive.get(context, 34), color: const Color(0xFFFFFFFF)),
                  ],
                )
              ],
            ),
          ...
          CircleAvatar(
            ...
            child: const Icon(Icons.phone, color: Color(0xFFF9F9F9), size: 20,),
          ),
                  ...
                  return ValueListenableBuilder(
                    ...
                    builder: (_, val, __){
                      return val==0
                        ...
                        : val==1
                        ? NumberDialog(
                          onSubmit: ()=> dialogNotifier.value=2,
                        )
                        : val==2 ? MailDialog(
                          onSubmit: ()=> dialogNotifier.value=3,
                        ) : val==3 
                        ? OtpDialog(
                          onSubmit: ()=>dialogNotifier.value=4)
                        : ConfirmedDialog(
                          onSubmit: (){
