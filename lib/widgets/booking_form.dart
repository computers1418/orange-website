    ...
    return Stack(
      children: [
        Container(
          ...
          padding: EdgeInsets.fromLTRB(16, SizeResponsive.getHeightverse(context, 34), 16, 10),
            ...
            children: [
                      ...
                      child: SizedBox(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            hintText: "Date & Time",
                            hintStyle: hintStyle,
                            suffixIcon: const Icon(Icons.arrow_drop_down_rounded, color: Color(0xFF2B275A),),
                            contentPadding: const EdgeInsets.symmetric(vertical: 0, horizontal: 20),
                            focusedBorder: border,
                            disabledBorder: border,
                            enabledBorder: border,
              ...
              ValueListenableBuilder(
                ...
                builder: (_, val, __) {
                  return Visibility(
                    visible: !val,
                    replacement: const SizedBox(height: 64,),
                    child: GestureDetector(
                      onTap: (){
                      ...
                      child: Container(
                        ...
                        child: Stack(
                          alignment: Alignment.center,
                          children: [
                            Text("Complete Booking", style: TextStyle(
                              fontFamily: "Kumbhsans",
                             ...
                             Align(
                              ...
                              child: Padding(
                                padding: EdgeInsets.only(right: SizeResponsive.get(context, 18), bottom: 14),
                                child: const ImageIcon(AssetImage("res/icons/blink.png"), size: 10, color: Color(0xFFFF8412),)))
                          ],
                        ),
                      ),
                    ),
        ...
        Positioned(
          bottom: sheet, right: 0, left: 0,
          child: GestureDetector(
            onTap: (){
              bottomSheetController.reverse();
              showDoctor.value = false;
            },
            child: const DoctorCallSheet(name: 'Alex',))),
