...
class _BookingPageState extends State<BookingPage> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 200), (){
      controller.animateToPage(1, duration: const Duration(milliseconds: 400), curve: Curves.easeOut);
    });

    // PROFILE PAGE
    _slidercontroller = AnimationController(duration: const Duration(milliseconds: 1500), vsync: this);

    slideClose = Tween<Offset>(
        begin: const Offset(0, 0),
        end: const Offset(-500, -30)
      ).animate(CurvedAnimation(
        parent: _slidercontroller,
        reverseCurve: Curves.ease,
        curve: const Interval(0.2, 0.5, curve: Curves.easeOut),
      ));
    profileBottom = Tween<double>(
        begin: -1000,
        end: 0
      ).animate(CurvedAnimation(
        parent: _slidercontroller,
          ...
          children: [
            ...
            Column(
              children: [
                              ...
                              child: Transform.translate(
                                ...
                                child: PageView.builder(
                                  ...
                                  itemBuilder: (_, int itemIndex){
                                      ...
                                      var offset = itemIndex==0 ? controller.offset: controller.offset/itemIndex ;
                                      ...
                                      var pad10 = SizeResponsive.get(context, 10);
                                      var pad20 = SizeResponsive.get(context, 20);
                                      ...
                                      return Transform.translate(
                                              ...
                                              child: Transform.rotate(
                                                    angle: angle * (pi / 180),
                                                    child: Padding(
                                                      padding: EdgeInsets.fromLTRB(pad10, pad20, pad10, pad10),
                                                      child: Padding(
                                                        padding: EdgeInsets.fromLTRB(pad10, 0, pad10, pad20),
                                  ...
                                  Positioned(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text("Read Client Reviews", style: TextStyle(
                                          color: Colors.white,
                                        ...
                                        Icon(Icons.arrow_forward, size: SizeResponsive.get(context, 10), color: Colors.white)
                                      ],
                                    ),
                                  ),
                      ],
                ...
                Visibility(
                  visible: MediaQuery.of(context).size.height>=800 && MediaQuery.of(context).size.width <450,
                            ...
                            children: [
                              Expanded(
                                child: GestureDetector(
                                  onTap: ()=>closeProfile(),
                                  child: Container(
                                    height:  MediaQuery.of(context).size.height>700 ? SizeResponsive.get(context, 60) : SizeResponsive.get(context, 45),
                                    alignment: Alignment.center,
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(34),
                                      border: Border.all(width: 2, color: const Color(0x332B275A))
                                    ),
                              ...
                              16.hgap(),
                              Expanded(
                                child: StyledButton(text: "SELECT", secondary: MediaQuery.of(context).size.height>700 ? false : true,)
                              )
                            ],
                          ),
                        )
