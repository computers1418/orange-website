...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    strip = Tween<double>(begin: -1000, end: 40).animate(CurvedAnimation(
      parent: _controller,
      reverseCurve: Curves.ease,
      curve: const Interval(
        0.2,
    ...
    button = Tween<double>(begin: -300, end: 0).animate(CurvedAnimation(
      parent: _controller,
      reverseCurve: Curves.ease,
      curve: const Interval(
        0.3,
    ...
    side2 = Tween<double>(begin: -186, end: -130).animate(CurvedAnimation(
      parent: _controller,
      reverseCurve: Curves.ease,
      curve: const Interval(
        0.3,
    ...
    headerBadge = Tween<double>(begin: 600, end: 0).animate(CurvedAnimation(
      parent: _controller,
      reverseCurve: Curves.ease,
      curve: const Interval(
        0.3,
    ...
    cards = Tween<Offset>(begin: const Offset(0, 800), end: const Offset(0, 0))
    ...
    watermark = Tween<double>(begin: 200, end: 0).animate(CurvedAnimation(
      parent: _controller,
      reverseCurve: Curves.ease,
      curve: const Interval(
        0.3,
  ...
  void _onScroll() {
    ...
    if (offset <= 1) {
      ...
      offsetNotifier.value = Offset(
          ...
          offset < 1.2
              ? 0
              : (offset / 3) * (MediaQuery.of(context).size.height / 4));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Container(
          decoration: const BoxDecoration(color: Color(0xffff8412)),
          child: Stack(
            children: [
              AnimatedBuilder(
                  animation: strip,
                      ...
                      child: Container(
                        ...
                        child: PageView.builder(
                            ...
                            itemBuilder: (context, idx) {
                              return Padding(
                                padding:
                                    const EdgeInsets.fromLTRB(20, 20, 34, 60),
                                child: AnimatedBuilder(
                                    animation: _pageController,
                                    builder: (_, __) {
                                      double offset =
                                          _pageController.offset / screenHeight;

                                      return Opacity(
                                        opacity: (1 + idx - offset) > 1
                                            ? 1
                                            : (1 + idx - offset) < 0
                                                ? 0
                                                : (1 + idx - offset),
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      height:
                                          SizeResponsive.getMin(context, 50),
                                    )
                                  ],
                                ),
                              ),
                      ...
                      child: Transform.rotate(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            height: SizeResponsive.get(context, 80),
                            decoration: const BoxDecoration(
                              image: DecorationImage(
